...
$(function() {
    ...
    $("#reset-password-form").on('submit',(function(e) {
        ...
        e.preventDefault();
        $.ajax({url: WEBSITE_URL + "dashboard/force_password_change", type: "POST", data:  new FormData(this), contentType: false, cache: false, processData:false,
            success: function(response) {
                ...
                if(response.status == "success")
                {
                    ...
                    swal({title: "Success!", text: response.message, confirmButtonColor: "#66BB6A", icon: "success", timer: 3000})
                    .then((result) => {
